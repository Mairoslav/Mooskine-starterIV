...
class NotebooksListViewController: UIViewController, UITableViewDataSource {
    ...
    // 00:27 By pressing Option and clicking on [Notebook] and choosing link under Defined in 'notebook.swift', let's see how notebooks are defined. Let's move to 'notebook.swift'...
